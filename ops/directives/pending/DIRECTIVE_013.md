...
## OBJECTIVE
To execute a directive by performing specified actions and generating a response file.
...
1. Write response to `/Users/markjferguson/T-E-Branch-clean/ops/responses/OC_RESPONSE_DIRECTIVE_013.md` with sections:
   - SUMMARY
   - ACTIONS TAKEN
   - FILES_MODIFIED
   - COMMANDS_RUN
   ...
   - BLOCKERS
   - COMMIT STATUS
2. Run: `git -C /Users/markjferguson/T-E-Branch-clean add ops/responses/ && git -C /Users/markjferguson/T-E-Branch-clean commit -m '[RESPONSE] OC_RESPONSE_DIRECTIVE_013 written'`
3. Write '## RESPONSE_COMPLETE' as the FINAL line of the response file.

## FILES_IN_SCOPE
- `/Users/markjferguson/T-E-Branch-clean/ops/directives/pending/DIRECTIVE_013.md` (input)
- `/Users/markjferguson/T-E-Branch-clean/ops/responses/OC_RESPONSE_DIRECTIVE_013.md` (output)
